...
var Connector = function () {
  ...
  _createClass(Connector, [{
    ...
    key: "updateHandle",
    value: function updateHandle(port) {
    ...
    value: function placeHandle() {
      ...
      try {
        for (var _iterator = shapes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {if (window.CP.shouldStopExecution(3)){break;}
          ...
          if (Draggable.hitTest(this.dragElement, shape.element)) {
            ...
            try {
              for (var _iterator2 = _ports[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {if (window.CP.shouldStopExecution(2)){break;}
...
var NodePort = function () {
  ...
  _createClass(NodePort, [{
    ...
    key: "removeConnector",
    value: function removeConnector(connection) {
    ...
    key: "addConnector",
    value: function addConnector(connection) {
    ...
    value: function update() {
      ...
      try {
        for (var _iterator3 = this.connectors[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {if (window.CP.shouldStopExecution(4)){break;}
  ...
  _createClass(NodeShape, [{
    ...
    value: function onDrag() {
      ...
      try {
        ...
        for (var _iterator4 = this.inputs[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {if (window.CP.shouldStopExecution(5)){break;}
...
window.CP.exitedLoop(5);
      ...
      try {
        for (var _iterator5 = this.outputs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {if (window.CP.shouldStopExecution(6)){break;}
...
var Diagram = function () {
  ...
  _createClass(Diagram, [{
    ...
    key: "prepareTarget",
    value: function prepareTarget(event) {

      var element = event.target;
      var drag = void 0;

      while (!(drag = element.getAttribute("data-drag")) && element !== svg) {if (window.CP.shouldStopExecution(7)){break;}
